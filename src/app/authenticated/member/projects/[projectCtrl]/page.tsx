...
import ProjectsViewTab1 from "@/app/authenticated/administrator/projects/[projectCtrl]/tab1/ProjectsViewTab1";
                ...
                pageName={[
                    {
                        'name': 'Projects',
                        'ilast': true,
                        'address': '/authenticated/member/projects/'
                    },
                    {
                        'name': 'View Project',
                        'last': false
                    },
                    {
                        'name': projectCtrl,
                        'last': true,
                        'address': `/authenticated/member/projects/${projectCtrl}`
                    }
                ]}
            />
            ...
            <div className="card rounded-0 custom-bg custom-border-dark">
                <div className="card-body p-0">
                    <div role="tabpanel" hidden={tabId !== 0} id={`simple-tabpanel-0`} aria-labelledby={`simple-tab-0`}>
                        {(tabId === 0) && <ProjectsViewTab1 projectCtrl={projectCtrl} isFromNonAdmin />}
                    </div>
                    ...
                    <div role="tabpanel" hidden={tabId !== 2} className="px-3 pt-4" id={`simple-tabpanel-2`} aria-labelledby={`simple-tab-2`}>
