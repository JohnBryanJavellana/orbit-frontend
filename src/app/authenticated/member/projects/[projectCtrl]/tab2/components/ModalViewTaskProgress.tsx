                                                                ...
                                                                <div className="col-xl-12 custom-border-dark">
                                                                    <div className="row p-3">
                                                                        <div className={`col-2 d-flex align-items-center justify-content-center text-center`}>
                                                                            <CustomAvatarWithOnlineBadge height={50} width={50} src={`${urlWithoutApi}/user-images/${progress.initiator.user.profile_picture}`} isOnline={progress.initiator.user.is_online} />
                                                                        </div>
